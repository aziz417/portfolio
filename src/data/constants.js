export const Bio = {
  ...
  resume:
    "https://drive.google.com/drive/u/1/folders/1lZNioK6RRD2nRdfav7t-_HATUOCj06yj",
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "JQuery",
        image:
          "https://icons-for-free.com/iconfiles/png/512/jquery+icon-1320185152994214115.png"
      },
      {
        name: "JavaScript",
        image:
...
export const experiences = [
  {
    ...
    desc: "Working on diffrent projects NextJs, TailwindCSS, Laravel, .",
    skills: [
      "Docker",
      "Terraform",
      "AWS",
